...
const IdeaDetails = ({
  ...
  const { id, appId, title } = useParams()
  ...
  useEffect(() => {
    ...
    let mounted = true
    getApplicantDetailById(mounted, id, 'labincharge', () => setLoading(false))
    return () => {
  ...
  const [appData, setAppData] = useState({
    remarks: '',
    application_verdict: 'Admin_PENDING'
  })
                          ...
                          <Form.Group
                            ...
                            <InputGroup>
                              ...
                              <FormControl
                                ...
                                onChange={handleChange}>
                                <option value="Admin_PENDING">Approved</option>
